export const COURSE_DATA = [
  {
    ...
    lessons: [
      {
        id: 1,
        title: 'Aula 1.1 - O Que é Renda Fixa e Por Que Ela Importa?',
        contentHtml: `
      ...
      {
        id: 2,
        title: 'Aula 1.2 - Renda Fixa versus Renda Variável',
        contentHtml: `
        <div class="contentHtml">
          ...
          <p><i>“Eu vou te emprestar 1kg de farinha. Daqui a uma semana, você precisa me devolver a mesma quantia de farinha emprestada e, como agradecimento, você deverá me dar um pedaço do bolo que vai fazer.”</i> </p>
          </section>
          ...
          <p><i>“Eu vou te emprestar toda a farinha necessária para o bolo e você entra com todos os outros ingredientes. Ao invés de me dever uma fatia, nós dois seremos sócios do bolo e vamos dividir o resultado.”</i> </p>
          </section>
          <p>Aqui, diferente do primeiro exemplo, o retorno é variável, porque depende do sucesso do bolo. Há três possibilidades: </p>
          <p><strong>Cenário ótimo</strong> – O bolo ficou incrível! Todo mundo que passa por vocês dois quer comprar um pedaço do bolo para provar, e vendem por um valor altíssimo. Como sócio, os lucros obtidos da venda serão distribuídos, e você vai receber um retorno maior. </p>
          <p><strong>Cenário “ok”</strong> – O bolo fica bom, mas não incrível. Vocês conseguem vender algumas fatias, mas o lucro é pequeno. Como o lucro é pequeno, os dois vão acabar recebendo menos retorno. </p>
          <p><strong>Cenário péssimo</strong> – O bolo queimou no forno! Não há bolo para dividir e nem para vender. E a farinha que você deu? Ela foi usada e perdida no processo. Você não recebe nada de volta, nem mesmo a farinha que investiu. Você perdeu seu capital inicial. </p>
        </div>
        `,
      },
      {
        id: 3,
        title: 'Aula 1.3 - As Três Engrenagens de um Título',
        contentHtml: `
        <div class="contentHtml">
          <h3 class="subtitle">Entendendo os três pilares que definem um investimento em Renda Fixa</h3>
          ...
          <section class="bg-1">
          <h5>Rentabilidade Pré-Fixada</h5>
          <ul>
          ...
          <section class="bg-2">
          <h5>Rentabilidade Pós-Fixada</h5>
          <ul>
  ...
  // MÓDULO 2 (Novo)
  {
    ...
    lessons: [
      {
        id: 4,
        title: 'Aula 2.1: O Universo Expandido da Renda Fixa',
        contentHtml: `
        <div class="contentHtml">
          <h4>Emprestando Dinheiro para Empresas: As Debêntures</h4>
          ...
          <div class="bg-1">
          <p><strong>Suas categorias são:</strong></p>
          <ul>
          ...
          <h4>Agências de classificação de crédito</h4>
          ...
          <div class="bg-1">
          <p><strong>Os ratings funcionam da seguinte maneira:</strong></p>
          <ul>
          ...
          <h4>Investindo no Mercado Imobiliário e no Agronegócio: CRI e CRA</h4>
          ...
          <h4>A Arte da Diversificação na Renda Fixa</h4>
      ...
      {
        id: 5,
        title: 'Aula 2.2: Os Riscos que Você Precisa Conhecer (e Como se Proteger)',
        contentHtml: `
        <div class="contentHtml">
          <h4>O Risco de Calote (Risco de Crédito)</h4>
          ...
          <h4>A "Montanha-Russa" dos Preços (Risco de Mercado)</h4>
          ...
          <div class="bg-1">
          <p><strong>É possível que sejam cobradas taxas sobre o investimento, caso você venda o título antes da data do vencimento. Mas, desconsiderando os impostos aplicados, vamos pensar em exemplos:</strong></p>
          <ul>
          ...
          <div class="bg-2">
          <p><strong>É possível usar a analogia de um ticket de show.</strong></p>
          ...
          <h4>A Dificuldade de Vender (Risco de Liquidez)</h4>
      ...
      {
        id: 6,
        title: 'Aula 2.3: Impostos e a Escolha Final: Colocando Tudo na Ponta do Lápis',
        contentHtml: `
        <div class="contentHtml">
          <h4>O "Sócio" do seu Lucro: Imposto de Renda e IOF</h4>
          ...
          <h4>A Comparação Definitiva: Títulos Tributáveis vs. Isentos</h4>
          ...
          <p>Para responder à pergunta: <i>"O que rende mais, um CDB de 120% do CDI ou uma LCI de 95% do CDI?"</i>, é preciso calcular a rentabilidade líquida. A rentabilidade líquida é o que efetivamente entra no seu bolso após o desconto dos impostos.</p>
          ...
          <h4>Checklist Prático: Como Analisar um Título</h4>
  ...
  // MÓDULO 3 (Novo)
  {
    ...
    lessons: [
      {
        id: 7,
        title: 'Aula 3.1: O Ponto de Partida Obrigatório: Sua Reserva de Emergência',
        contentHtml: `
        <div class="contentHtml">
          ...
          <section class="bg-1">
          <h4>Títulos Ideais para a Reserva:</h4>
      ...
      {
        id: 8,
        title: 'Aula 3.2: Usando a Renda Fixa para Seus Objetivos de Vida',
        contentHtml: `
        <div class="contentHtml">
          <h4>Defina o Prazo do Seu Sonho:</h4>
          ...
          <h4>Para Objetivos de Curto e Médio Prazo (até 5 anos):</h4>
          ...
          <h4>Para Objetivos de Longo Prazo (Aposentadoria):</h4>
      ...
      {
        id: 9,
        title: 'Aula 3.3: Mantendo o Rumo: Disciplina e Próximos Passos',
        contentHtml: `
        <div class="contentHtml">
          <h4>Mitos Comuns (Para Você Não Cair em Ciladas):</h4>
          <div class="bg-3">
          <ul>
          ...
          <h4>O Segredo do Sucesso: Disciplina e Paciência:</h4>
          <p>O maior motivo de separação dos investidores de sucesso e os demais não é encontrar a "fórmula mágica", mas sim a constância nos investimentos.</p>
